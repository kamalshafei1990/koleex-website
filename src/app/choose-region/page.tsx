...
const regionGroups: RegionGroup[] = [
  ...
  /* ═══ MIDDLE EAST & AFRICA ═══ */
  {
    ...
    countries: [
      ...
      { name: "Democratic Republic of the Congo", flag: "🇨🇩", languages: [{ label: "Français", href: "/africa/fr" }, { label: "English", href: "/africa/en" }] },
  ...
  /* ═══ EURASIA ═══ */
  {
    ...
    countries: [
      ...
      { name: "Armenia", flag: "🇦🇲", languages: [{ label: "Հայերեն", href: "/eurasia/hy" }, { label: "English", href: "/eurasia/en" }] },
