      ...
      <div className="flex flex-col md:flex-row min-h-[420px]">
        {section.image_url && (
          <div className="md:w-[52%] overflow-hidden">
            <CmsImage src={section.image_url} alt={section.image_alt || section.title || ""} className="w-full h-full object-cover min-h-[260px] md:min-h-[420px]" />
          </div>
        )}
        <div className="md:w-[48%] flex items-center px-8 md:px-14 lg:px-16 py-12 md:py-0">
